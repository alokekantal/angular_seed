...
import { JobCreationService } from '../layout/core/job-creation/job-creation.service';
...
@Component({
  ...
  templateUrl: './newPreviewJob.component.html',
  styleUrls: ['./newPreviewJob.component.css'],
  providers: [JobCreationService, UtilityService, CommonService],
  encapsulation: ViewEncapsulation.None
})
// tslint:disable-next-line:component-class-suffix
export class NewPreviewJob implements OnInit {
  @Input() title: string;
  ...
  checkbocCollapse = {  
                        isCollapsedToBeInclude: false,
                        isCollapsedMeterials: false,
                        isCollapsedTheWorkToBeSurvedAlsoBy: false
                    };
  ...
  ngOnInit() {
    ...
    this.options = {
      removePlugins: 'save,preview,find,format,image,justify,tabletools,link,sourcearea, flash, about', 
      removeButtons: 'Strike,Subscript,Superscript,PasteFromWord, Form'
    }
    this.id = this.inputModel.id;
    this.utilityService.showLoader();
    const date = {
